...
public class ArtworkServiceImpl implements ArtworkService{
    ...
    public DetailArtworkResponse getDetailArtwork(Long artworkId) {
        ...
        response.updateUrl(uploadDir+"/artwork/");
        return response;
    }
    ...
    public List<ArtworkResponse> getArtworkList() {
        ...
        response.forEach(r -> r.updateUrl(uploadDir + "/artwork/"));
        return response;
    }
    ...
    public Map<String,String> saveImage(MultipartFile image) {
        try {
            ...
            // 3. 저장 경로
            File saveFile = new File(uploadDir + "/artwork/" + fileName);
    ...
    private void deleteImage(String imageName){
        File file = new File(uploadDir+"/artwork/"+imageName);
        if (file.exists()) {
            file.delete();
