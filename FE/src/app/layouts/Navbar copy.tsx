...
export default function Navbar() {
  ...
  // ✅ [추가] 메뉴 닫힐 때 aria-hidden 전 focus 정리 (경고 해결)
  useEffect(() => {
    if (open) return; // 닫힐 때만
    ...
    // refMenu 내부에 포커스가 남아있으면, 메뉴 버튼으로 되돌리거나 blur
