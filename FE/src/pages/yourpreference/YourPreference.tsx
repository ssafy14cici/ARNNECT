...
import { useAuthStore } from "../../stores/authStore"; // 경로 확인 필요
...
const ROUNDS = [
  {
    id: 1,
    question: "Round 1/4",
    left: { id: "A1", src: "https://images.unsplash.com/photo-1547891654-e66ed7ebb968?auto=format&fit=crop&w=800&q=80", type: "Abstract" },
    right: { id: "B1", src: "https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?auto=format&fit=crop&w=800&q=80", type: "Classic" },
  },
  {
    id: 2,
    question: "Round 2/4",
    left: { id: "A2", src: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=800&q=80", type: "Vivid" },
    right: { id: "B2", src: "https://images.unsplash.com/photo-1507643179173-617d654f3daf?auto=format&fit=crop&w=800&q=80", type: "Mono" },
  },
  {
    id: 3,
    question: "Round 3/4",
    left: { id: "A3", src: "https://images.unsplash.com/photo-1515405295579-ba7b45403062?auto=format&fit=crop&w=800&q=80", type: "Warm" },
    right: { id: "B3", src: "https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?auto=format&fit=crop&w=800&q=80", type: "Cold" },
  },
  {
    id: 4,
    question: "Round 4/4",
    left: { id: "A4", src: "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?auto=format&fit=crop&w=800&q=80", type: "Minimal" },
    right: { id: "B4", src: "https://images.unsplash.com/photo-1582560475093-6f498e642f37?auto=format&fit=crop&w=800&q=80", type: "Complex" },
  },
];
...
export default function YourPreference() {
  ...
  const startTest = () => {
    if (!checkLimit()) {
      if (confirm("비회원은 한 번만 참여할 수 있습니다.\n회원가입 후 무제한으로 즐겨보세요!")) {
        navigate("/signup");
      }
      return;
    }
  ...
  const handleSelect = (choice: { id: string; type: string }) => {
    const newSelections = [...selections, { round: currentRoundIdx + 1, selectedId: choice.id, type: choice.type }];
  ...
  const IntroView = (
    <div className="pref-intro fade-in">
      ...
      <p className="pref-desc">
        이름도, 장르도 모른 채 오직 <strong>그림</strong>만으로 선택하세요.<br />
      ...
      {!isLoggedIn && <p className="pref-limit-notice">* 비회원은 1회만 가능합니다.</p>}
    </div>
  );
    ...
    <div className="pref-result fade-in">
      <div className="result-card">
        ...
        <div className="result-keywords">
          {resultData?.keywords.map((k: string) => <span key={k}>{k}</span>)}
        </div>
