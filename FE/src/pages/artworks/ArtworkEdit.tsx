    ...
    (async () => {
      ...
      try {
        ...
        const d: Detail = {
          ...
          size: payload?.size ?? "",
          tags: payload?.tags ?? [],
          imageUrl: payload?.imageUrl ?? payload?.thumbnailUrl ?? "",
        };
  ...
  return (
    <div className="post-create-page theme-artist">
      <div className="pc-container">
        ...
        {/* ✅ edit 모드 */}
        <ArtworkForm mode="edit" submitting={loading} onSubmit={onSave} initial={initial ?? undefined} />
      </div>
    </div>
  );
}
