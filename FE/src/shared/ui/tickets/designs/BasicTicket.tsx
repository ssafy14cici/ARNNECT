    ...
    <div style={{
      ...
      <div style={{ 
        ...
        {data.posterUrl ? (
          ...
          <div style={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", color: "#ccc", fontSize: "2rem", fontWeight: "100" }}>
            ART
          </div>
        )}
      </div>
      ...
      <div style={{ 
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", flex: 1 }}>
          <div style={{ fontSize: "10px", color: "#666", letterSpacing: "1px" }}>
            ...
            <p style={{ margin: "4px 0 0" }}>{data.addressDetail}</p>
          </div>
          ...
          <div style={{ width: "40px", height: "40px", backgroundColor: "#000", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "8px" }}>
            QR
          </div>
        </div>

        {/* 오른쪽: 세로 타이틀 (ELOQUENCE 스타일) */}
        <div style={{ 
